...
function TweetTick(ob)
{
	...
	$(ob.results).each(function(el){
		...
		'<div class="avatar"><a href="http://twitter.com/'+this.from_user+'" target="_blank">'+
		'<img src="'+this.profile_image_url+'" alt="'+this.from_user+'" /></a></div><div class="user">'+
		'<a href="http://twitter.com/'+this.from_user+'" target="_blank">'+this.from_user+'</a>'+
		'</div><div class="time">'+relativeTime(this.created_at)+'</div>'+
		'<div class="txt">'+formatTwitString(this.text)+'</div></div>';
