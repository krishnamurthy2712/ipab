...
public class IDidnotPaid 
{
	...
	private static final String TYPE = "notpaid";
	 ...
	 /* Here is the instance of the Singleton */
	  ...
	  public ArrayList<DidNotPaidBribesVO> viewDintPay(int limit)
	  {
		  ...
		  String query = "SELECT bc.*, ct.city_name AS c_city, bd.dept_name, bt.trans_name FROM bd_dint_bribe bc, bd_dept bd, bd_transactions bt, bd_city ct WHERE bc.c_dept=bd.id AND bc.c_transaction=bt.id and bc.approved=1 and bc.c_city=ct.Id order by bc.id desc "+searchCriteria;
	  ...
	  public ArrayList<DidNotPaidBribesVO> viewDintPayFiltered(String query)
	  {
		  ArrayList<DidNotPaidBribesVO> didnotPayBribes = new ArrayList<DidNotPaidBribesVO>();
